...
- **New run:** `run_20260825_203014` (replaces quarantined `run_20260825_070918`; old run kept on disk as evidence of the failure mode — see testing/QUARANTINE_TIER2.md)
